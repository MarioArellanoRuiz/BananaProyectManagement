   ...
   // on espera una acción
    ...
    function(event){ //Función manejadora
        ...
        //nuestro nuevo post
          ...
          '<div id="mi-post' + nuevoPost.numero+'"class="col-lg-sm" style="background-color:rgb(85, 186, 253); border-radius: 18px; padding: 15px; margin:35px; width: 80%; height: 180px;">'+
          
                      '<div class="container" align="center">'+ /////TITULOS ////////////////////////////////////////////// -->
                          '<strong style="font-size:8pt; color:rgb(0, 91, 151)">'+nuevoPost.postProyect+'</strong>'+ 
                          
                      '</div>'+
          
                      '<div class="container" aling="center">'+ ////FECHAS DEL PROYECTO ////////////////////////////////////////////////-->
                        '<div   Style="float:left; padding:1em;">'+
                          '<p style="font-size:5pt; color:rgb(236, 253, 255)">'+nuevoPost.postInicio+'</p>'+
                        '</div>'+
                        '<div  Style="float:left; padding:1em;">'+
                            '<p style="font-size:5pt; color:rgb(236, 253, 255)">'+nuevoPost.postFinal+'</p>'+
                        '</div>'+
                      '</div>'+
          
                        '<div class="container" aling="center">'+ //Estatus del Proyecto ///////////////////////////////// -->
                          '<p style="font-size:5pt; color:rgb(236, 253, 255);">'+nuevoPost.postDescrip+'</p>'+
                        '</div>'+
            
                        '<div class="container"aling="center">'+ //boton para borrar proyecto /////////////////////////////// -->
                          '<button class="btn btn-danger btn-sm post-delete" data-numero="'+ nuevoPost.numero +'" style="float:left;margin-left: -25%;">Delete</button>'+
